       	  ...
       	  <table width="985px" align="center">
            	<tr>
                	<td style="font-family:Verdana, Geneva, sans-serif">
                    	<br>
                        	<strong>Socorrista</strong><br>
                           
                        <ul>
                            <li><strong>Objetivo:</strong></li><br>
                            <li><strong>Carga Horária:</strong></li><br>
                            <li><strong>Público Alvo:</strong></li><br>
                            <li><strong>Conteúdo programático:</strong> </li><br>
                            <li><strong>Instruções metodológicas:</strong> </li><br>
                        </ul>                        
