...
<table border="0" cellpadding="0" cellspacing="0" width="98%" style="margin:10px;">
		...
		<td class="table_main">
			<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
				<tr>
					...
					<td align="left" width="" class="menu_topico">Relatórios [Carteirinhas] <?php print($_ClassUtilitarios->refTopico()); ?></td>
					<td align="right">
						<table border="0" cellpadding="2" cellspacing="0">
							...
							if($_REQUEST["submenu"] == "buscar" || $_SESSION["consultaCertificados"]["idMatricula"] > 0){
								?>
								<td align="center"><div class="caixaIcone"><a href="#" onclick="document.formCareitinhas.submit();"><img src="modulos/sistema/img.php?img=../../imagens/icones/00029.png&l=50&a=50" border="0"><br>Imprimir</a></div></td>
								<td align="center"><div class="caixaIcone"><a href="?sessao=rel_carteirinhas"><img src="modulos/sistema/img.php?img=../../imagens/icones/00030.png&l=50&a=50" border="0"><br>Nova Consulta</a><div></td>
								<?php
							}
							?>
						</table>
	...
	if($_REQUEST["submenu"] == ""){
		...
		<tr>
			<td class="table_main">
				<form action="?sessao=rel_carteirinhas&submenu=buscar" method="POST" name="formCareitinhas">
					...
					<table border="0" cellpadding="2" cellspacing="2" align="center">
						<tr bgcolor="#F9F9F9">
							...
							<td align='left'><input type="text" name="texto" size="50" disabled></td>
						 	<td width="5%" align="center"><input type="checkbox" name="habilitarPalavraChave" value="sim" onClick="disen(document.formCareitinhas.texto);" ></td>
						</tr>
						<tr>
							<td align="right"><b>Filtrar Turmas:</b></td>
							<td align='left'><input name="procura" type="text" size="30" onKeyUp="trocaOpcao(this.value, document.formCareitinhas.turma);" disabled></td>
							<td align='left'></td>
						</tr>
						<tr>
							...
							<td align='left'>
						 	...
						 	<td align="center"><input type="checkbox" name="habilitarTurma" value="sim" onClick="disen(document.formCareitinhas.turma);disen(document.formCareitinhas.procura);" ></td>
						</tr>
						<tr>
							<td align='left'>&nbsp;</td>
							<td align="right"><strong>Todas</strong></td>
							<td align="center"><input type="checkbox" name="todas" value="sim" onClick=" disen(document.formCareitinhas.habilitarPalavraChave);checkedDisable(document.formCareitinhas.habilitarPalavraChave);
																										 disen(document.formCareitinhas.habilitarTurma);checkedDisable(document.formCareitinhas.habilitarTurma);
																										 disable(document.formCareitinhas.texto);
																										 disable(document.formCareitinhas.procura);
																										 disable(document.formCareitinhas.turma);
		...
		<tr>
			<td class="table_main">
				<form action="<?php print($pathInc);?>modulos/relatorios/_rel.carteirinhas.emitir.php" method="POST" name="formCareitinhas" target="_blank">
					<table width="99%" border="0" cellpadding="2" cellspacing="2">
						<tr>
							<td colspan="2">
								...
								<table class="consulta" cellspacing="1" align="center">
									<thead>
										<tr>
											<th width="1%">#</th>
											<th width="1%" align="center"><input type="checkbox" onclick="select_all('formCareitinhas', 'registros[]')" checked></th>
									...
									<tbody>
										...
										*/
										...
										$_ClassPaginacao->setUrl("?sessao=rel_carteirinhas&subref=buscar&submenu=buscar");
