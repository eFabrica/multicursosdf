...
<table border="0" cellpadding="0" cellspacing="0" width="98%" style="margin:10px;">
		...
		<td class="table_main">
			<table width="99%" border="0" cellpadding="0" cellspacing="0" align="center">
				<tr>
					...
					<td align="left" width="" class="menu_topico">Relatórios [Horas Aula Geral] <?php print($_ClassUtilitarios->refTopico()); ?></td>
					<td align="right">
	...
	<tr>
		<td class="table_main">
			<form action="<?php print($pathInc . "modulos/relatorios/_rel.horasaulageral.emitir.php");?>" target="_blank" method="POST" name="formRelHorasAula">
				<input type="hidden" name="a" value="S">
				<table width="400" border="0" cellpadding="2" cellspacing="2" align="center">
					<tr>
						<td width="15%" align="right"><strong>Data:</strong></td>
						<td width='85%' align='left'>
							De <input type="text" id="dataI" name="dataI" size="12" onKeyUp="maskData(this, document.formRelHorasAula.dataF)">
					  		até <input type="text" id="dataF" name="dataF" size="12" onKeyUp="maskData(this, document.formRelHorasAula.dataF)">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td align='left'>&nbsp;</td>
						<td align='left'><?php print($_ClassUtilitarios->criaMenu("Gerar", "#", "document.formRelHorasAula.submit();", "esq", "007", $pathInc)); ?></td>
					</tr>
				</table>
			</form>
		</td>
