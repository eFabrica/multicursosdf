...
if(count($_REQUEST["registros"]) > 0){
	...
	<html>
		<head>
			<title>Declaração Provisória</title>
		...
		<body style="margin:0px;">
			...
			for($i = 0; $i < count($_REQUEST["registros"]); $i++){
				...
				<table width="650" border="0" cellspacing="0" cellpadding="0" style="margin-top:250px;" align="center">
					...
					<tr>
						<td style="border:2px solid #000000;" align="center"><h2><?php print("DECLARAÇÃO <u><em>provisória</em></u> DO CURSO " . strtoupper(" de " . $dadosCurso->nome));?></h2></td>
					</tr>
					<tr>
						<td align='left'><br /></td>
					</tr>
					<tr>
						<td align='left'>
							<div align="justify" style="line-height:200%;">
								...
								CPF nº <?php print($_ClassUtilitarios->formataCPF($dadosAluno->cpf));?>, concluiu com 
								...
								neste estabelecimento de ensino no período de 
					...
					<tr>
						<td style="border:2px solid #000000;">
							<em>OBS: Trata-se de Declaração Provisória com <strong><u>validade de 30 (Trinta) dias</u></strong>, 
							sendo que o Certificado será entregue após Homologação do CBMDF. </em>
						</td>
					</tr>
					<tr>
						<td align='left'><br /></td>
