...
if($_REQUEST["act"] == "salvar"){
	...
	if($_ClassMensagens->getMensagem_erro() == ""){
		...
		// Cadastra Receita
		$cadastraReceita = $_ClassMysql->query("INSERT INTO `receitas` SET  unidade = '" . $_dadosUnidade->id . "',
		...
		if($cadastraReceita){
			...
			$_ClassMensagens->setMensagem_sucesso("Receita gravada com sucesso!<br><br>[ <a href='?sessao=receita&ref=novo'>Atualizar</a> ]");
