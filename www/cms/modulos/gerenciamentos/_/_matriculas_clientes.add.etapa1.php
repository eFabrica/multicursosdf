...
if($_REQUEST["act"] == "salvar"){
	...
	// Redireciona
	print($_ClassUtilitarios->redirecionarJS("?sessao=matriculas&subsessao=" . $_REQUEST["subsessao"] . "&ref=novo&etapa=2"));
...
if(!$sucesso){
	...
	<tr>
		<td class="table_main">
			<form action="?sessao=matriculas&subsessao=<?php print($_REQUEST["subsessao"]);?>&ref=novo&etapa=1&submenu=buscar" method="POST" name="formMatricula_Busca">
				<table width="99%" border="0" cellpadding="2" cellspacing="2" align="center">
					<tr>
						<td align="right" width="10%"><b>Palavra-Chave:</b></td>
						<td width='90%' align='left'><input type="text" name="texto" size="50" value="<?php print($_REQUEST["texto"]);?>"></td>
					</tr>
					<tr>
						<td align='left'></td>
