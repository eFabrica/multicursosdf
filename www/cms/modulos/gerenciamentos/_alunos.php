...
<table border="0" cellpadding="0" cellspacing="0" width="98%" style="margin:10px;">
					...
					<td align="right">
						<table border="0" cellpadding="2" cellspacing="0">
							...
							if($_REQUEST["ref"] == ""){
								...
								?>
								<td align="center"><div class="caixaIcone"><a href="?sessao=alunos&ref=novo"><img src="modulos/sistema/img.php?img=../../imagens/icones/00031.png&l=50&a=50" border="0"><br>Novo</a></div></td>
								<?php
								...
								<td align="center"><div class="caixaIcone"><a href="?sessao=alunos<?php print((($_REQUEST["ref"] == "novo")?"&ref=":"&ordem=" . $_REQUEST["ordem"] . "&campo=" . $_REQUEST["campo"] . "&pg=" . $_REQUEST["pg"] . "&filtro=" . $_REQUEST["filtro"]));?>"><img src="modulos/sistema/img.php?img=../../imagens/icones/00027.png&l=50&a=50" border="0"><br>Cancelar</a></div></td>
								<?php
	...
	if($_REQUEST["ref"] == "novo"){
		...
		// Inclui Novo
		require_once($pathInc . "modulos/gerenciamentos/_/_alunos.add.php");
		
	}elseif($_REQUEST["ref"] == "edit"){
		
		// Inclui Edit
		require_once($pathInc . "modulos/gerenciamentos/_/_alunos.edit.php");
		
	}elseif($_REQUEST["ref"] == "sucesso"){
		
		// Inclui Edit
		require_once($pathInc . "modulos/gerenciamentos/_/_alunos.sucesso.php");
		...
		// Inclui Consulta
		require_once($pathInc . "modulos/gerenciamentos/_/_alunos.consulta.php");
