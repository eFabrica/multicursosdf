...
if($_REQUEST["act"] == "salvar"){
	...
	if($_ClassMensagens->getMensagem_erro() == ""){
		...
		$_ClassRn->getDadosTable("unidades", "id", "cnpj = '" . $_REQUEST["cnpj"] . "'");
	...
	if($_ClassMensagens->getMensagem_erro() == ""){
		...
		// Cadastra Unidade
		$cadastraUnidade = $_ClassMysql->query("INSERT INTO `unidades` SET razaosocial = '" . $_REQUEST["razaosocial"] . "',
		...
		if($cadastraUnidade){
			...
			$_ClassMensagens->setMensagem_sucesso("Unidade gravada com sucesso!<br><br>[ <a href='?sessao=unidades&ref=novo'>Atualizar</a> ]");
			...
			<form action="" method="POST" name="formUnidade">
				...
				<table width="99%" border="0" cellpadding="2" cellspacing="2" align="center">
					...
					<tr>
						...
						<td align='left'><input type="text" name="cep" size="12" maxlength="9" onKeyUp="maskCEP(this, document.formUnidade.cnpj)" value="<?php echo $_REQUEST["cep"]?>"></td>
					</tr>
					<tr>
						<td align="right"><b><font class="obrig">(*)</font> CNPJ:</b></td>
						<td align='left'><input type="text" name="cnpj" size="22" maxlength="18" onKeyUp="maskCNPJ(this, document.formUnidade.ie)" value="<?php echo $_REQUEST["cnpj"]?>" ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align='left'><input type="text" name="cpf" size="18" maxlength="14" onKeyUp="maskCPF(this, document.formUnidade.emailresponsavel)" value="<?php echo $_REQUEST["cpf"]?>"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align='left'>
							<select name="acesso">
								<option value="L" <?php echo(($_REQUEST["acesso"] == "L")?"selected":"")?>>Liberado</option>
								<option value="B" <?php echo(($_REQUEST["acesso"] == "B")?"selected":"")?>>Bloqueado</option>
							</select>
						</td>
					</tr>
					<tr>
